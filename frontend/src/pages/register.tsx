      ...
      <div className="relative z-10 w-full max-w-md mx-6">
        ...
        <div className={`backdrop-blur-lg rounded-2xl p-8 shadow-2xl border overflow-hidden ${
          ...
          <div className="text-center mb-8">
            ...
            <h1 className={`text-3xl font-bold mb-2 ${isDarkMode ? 'text-white' : 'text-gray-900'}`}>创建账户</h1>
            <p className={`mt-2 ${isDarkMode ? 'text-white/60' : 'text-gray-500'}`}>开启您的待办之旅</p>
          </div>

          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              <label className={`block text-sm font-medium mb-2 ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>用户名</label>
              <input
                type="text"
                name="username"
            ...
            <div>
              <label className={`block text-sm font-medium mb-2 ${isDarkMode ? 'text-white/80' : 'text-gray-700'}`}>确认密码</label>
              <input
                type="password"
